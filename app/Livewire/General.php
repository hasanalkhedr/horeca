...
class General extends Step
{
    ...
    public function mount()
    {
        $this->mergeState([
            ...
            'start_date' => $this->model->start_date->format('Y-m-d'),
            'end_date' => $this->model->end_date->format('Y-m-d'),
            'apply_start_date' => $this->model->apply_start_date->format('Y-m-d'),
            'apply_deadline_date' => $this->model->apply_deadline_date->format('Y-m-d'),
