...
class StandResource extends Resource
{
    ...
    //                         ->label('Updated At')
    //                         ->content(fn($record): string => $record?->updated_at ? $record->updated_at->format('M d, Y H:i') : '-'),
    //                 ])
    //                 ->columns(2)
    ...
    //             //         'Reserved' => 'Reserved',
    //             //     ])
    //             //     ->rules(['required', 'in:Available,Sold,Reserved'])
    //             //     // ->afterStateUpdated(function ($state, $record) {
    //             //     //     // Log status change if needed
    //             //     //     activity()
    //             //     //         ->performedOn($record)
    //             //     //         ->causedBy(auth()->user())
    //             //     //         ->withProperties(['old_status' => $record->status, 'new_status' => $state])
    //             //     //         ->log('Stand status updated');
    //             //     // })
    //             //     ->sortable()
    //             //     ->searchable()
    //             //     ->alignCenter()
    ...
    //                     // Show status with change button (except for Sold)
    //                     if ($state !== 'Sold') {
    //                         return $state . ' ▼';
    //                     }
    //                     return $state;
    ...
    //                 ->label('Contract No.')
    //                 //->url(fn ($record) => $record->Contract ? ContractResource::getUrl('view', ['record' => $record->Contract->id]) : null),
    //                 ->default('-'),
    ...
    //                         ])
    //                         ->required()
    //                         ->helperText('Note: Cannot change to "Sold" status via bulk action'),
    //                 ])
