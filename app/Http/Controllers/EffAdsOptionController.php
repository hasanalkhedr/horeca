...
class EffAdsOptionController extends Controller
{
    public function index(Request $request) {
        $options = EffAdsOption::query();
        ...
        return view('eff-ads-options.index', compact('options'));
    }
    ...
    public function store(Request $request) {
        ...
        $option = EffAdsOption::create($request->only(['title', 'description']));
        ...
        return response()->json(['message' => 'effective Ads option created successfully']);
    }

    public function update(Request $request, EffAdsOption $adsOption) {
        $validator = Validator::make($request->all(), [
        ...
        return response()->json(['message' => 'Effective Ads option updated successfully']);
    }

    public function destroy(EffAdsOption $adsOption) {
        $adsOption->delete();
        return response()->json(['message' => 'Effective Ads option deleted successfully']);
    }

    public function show(EffAdsOption $adsOption) {
        ...
        return view('eff-ads-options.show', compact('adsOption', 'currencies', 'availableCurrencies'));
    }

    /**
     * Add currency to ads option
     */
    public function addCurrency(Request $request, EffAdsOption $adsOption) {
        $validator = Validator::make($request->all(), [
     ...
     */
    public function removeCurrency(EffAdsOption $adsOption, Currency $currency) {
