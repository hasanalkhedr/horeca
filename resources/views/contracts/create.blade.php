    ...
    <form action="{{ route('contracts.store') }}" method="POST"
        ...
        <div class="flex flex-wrap -mx-3 mb-2">
            <div class="w-1/3 px-3">
                ...
                <x-text-input name="contract_number" value="0000c01" />
            </div>
            <div class="w-1/3 px-3">
                <x-input-label>
        ...
        <div class="flex flex-wrap -mx-3 mb-2">
            ...
            <div class="w-full px-3">
                ...
                @foreach ($prices as $price)
                    <div class="block">
                        <input type="radio" name="price_id" value="{{ $price->id }}" onclick="toggleAmountInput(this)" /> {{ $price->name }} |
                ...
                <div class="block">
                    ...
                    <input class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" name="special_price_amount" id="special_price_amount" type="number" step="0.01" disabled />
                    <script>
        ...
        <input type="hidden" name="contract_type_id" value="{{ $contract_type->id }}">
        <input type="hidden" name="event_id" value="{{ $event->id }}">

        <div class="pt-4">
            <button type="submit"
                class="w-full bg-blue-600 text-white py-3 px-4 rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                Submit
            </button>
        </div>
