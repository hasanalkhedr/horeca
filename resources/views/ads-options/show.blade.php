...
@section('content')
    <div class="container mx-auto px-4 py-8" x-data="optionTable()">
        <div class="flex justify-between items-center mb-6">
            <div>
                <a href="{{ route('ads-options.index') }}" class="text-blue-500 hover:text-blue-700">
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            ...
            <div class="mt-6">
                            ...
                            @foreach ($adsOption->currencies as $currency)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right">
                                        <form action="{{ route('ads-options.remove-currency', [$adsOption->id, $currency->id]) }}"
                                              method="POST"
                ...
                <div class="mt-4">
                    ...
                    <form action="{{ route('ads-options.add-currency', $adsOption->id) }}" method="POST" class="flex items-end space-x-4">
                        @csrf
                        <div class="flex-1">
        ...
        function optionTable() {
            return {
                ...
                submitForm() {
                    ...
                    fetch(`{{ route('ads-options.update', '') }}/${this.selectedOptionId}`, {
                        method: 'PUT',
                        headers: {
                ...
                confirmDelete() {
                    ...
                    .then(() => {
                        this.closeModal();
                        window.location.href = '{{ route('ads-options.index') }}';
                    });
                },
            };
        }
