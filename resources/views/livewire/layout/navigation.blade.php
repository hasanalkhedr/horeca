            ...
            <div class="-mr-2 flex sm:hidden">
                <button @click="profileOpen = !profileOpen"
                    ...
                    <svg class="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24">
                        <path :class="{ 'hidden': profileOpen, 'inline-flex': !profileOpen }" class="inline-flex"
                            stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M4 6h16M4 12h16M4 18h16" />
                        <path :class="{ 'hidden': !profileOpen, 'inline-flex': profileOpen }" class="hidden"
                ...
                <div class="relative" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
                    <div @click="open = ! open">
                        <button
                            ...
                            <img src="{{ auth()->user()->getProfilePictureUrlAttribute() }}" alt="Profile Picture" class="w-30 h-10 m-2 rounded-full">
