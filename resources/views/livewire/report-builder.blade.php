<div class="flex min-h-screen bg-gray-100">
            ...
            <div class="space-y-2">
                @foreach ([
                    ...
                    <div x-data="{ open: false }" class="border rounded-md">
                        <!-- Collapsible Header -->
                        <button @click="open = !open" class="w-full text-left p-3 bg-gray-50 hover:bg-gray-100 flex justify-between items-center">
                        ...
                        <div x-show="open" x-collapse class="p-3 space-y-2">
                            ...
                            <div class="text-sm text-gray-600">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="text" wire:model.live="paymentMethod" class="w-full px-3 py-2 border rounded-md focus:ring focus:ring-blue-200 focus:outline-none" placeholder="Enter bank account details">
                                    <label class="block text-gray-700 font-semibold">Bank Account Number</label>
                                    <input type="text" wire:model.live="bankAccount" class="w-full px-3 py-2 border rounded-md focus:ring focus:ring-blue-200 focus:outline-none" placeholder="Enter bank account details">
                                    <label class="block text-gray-700 font-semibold">Bank Name and Address</label>
                                    <input type="text" wire:model.live="bankNameAddress" class="w-full px-3 py-2 border rounded-md focus:ring focus:ring-blue-200 focus:outline-none" placeholder="Enter bank account details">
                                    <label class="block text-gray-700 font-semibold">Swift Code</label>
                                    <input type="text" wire:model.live="swiftCode" class="w-full px-3 py-2 border rounded-md focus:ring focus:ring-blue-200 focus:outline-none" placeholder="Enter bank account details">
                                    <label class="block text-gray-700 font-semibold">IBAN</label>
                                    <input type="text" wire:model.live="iban" class="w-full px-3 py-2 border rounded-md focus:ring focus:ring-blue-200 focus:outline-none" placeholder="Enter bank account details">
                            ...
                            <button wire:click="addComponent('{{ $component }}')" class="w-full px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none">
                                Add {{ $label }}
                            </button>
                        </div>
                    </div>
        ...
        @if ($message)
            <div class="p-4 @if ($messageType === 'success') bg-green-100 border-green-400 text-green-700 @else bg-red-100 border-red-400 text-red-700 @endif rounded">
                ...
                @if ($messageType === 'success')
                    <div class="flex-1 px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 focus:outline-none">
    ...
    <div class="flex-1 ml-64 p-6">
        ...
        <div class="space-y-1 bg-gray-100">
            <div class="page mx-auto bg-white min-h-[297mm] max-w-[210mm] shadow-lg print:shadow-none p-[10mm] my-8 print:my-0">
                <div x-data="{
                    initSortable() {
                    ...
                    <div x-ref="sortableList" class="space-y-2">
                        @foreach ($selectedComponents as $index => $component)
                            <div data-id="{{ $component }}"
                                ...
                                @if ($component == 'payment-section')
                                    @livewire($component, [null,$paymentMethod,
                                    $bankAccount,
                                    $bankNameAddress,
                                    $swiftCode,
                                    $iban,], key($component . '-' . $index))
                                @else
