<div class="">
    ...
    <div class="w-full px-4 mx-4">
        <h2>Effective Advertisement Packages</h2>
        <div class="flex w-full">
            <div class="w-1/2">
                <div x-data="{ all_eff_ads_packages: @entangle('state.all_eff_ads_packages') }">
                    <h1>Available Packages</h1>
                    <template x-for="package in JSON.parse(all_eff_ads_packages)">
                        <div x-data="{ open: false }" class="border rounded-md">
                            <button @click="open = !open" type="button"
                                class="w-full text-left p-3 bg-gray-50 hover:bg-gray-100 flex justify-between items-center">
                                <span class="font-medium text-gray-700" x-text="package.title"></span>
                            ...
                            <div x-show="open" x-collapse class="p-3 space-y-2">
                                ...
                                <button wire:click="addEffAdsPackageToEvent(package)" type="button"
                                    class="w-full px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none">
                                    Add this package to the event
                                </button>
                            </div>
            ...
            <div class="w-1/2">
                <div x-data="{ event_eff_ads_packages: @entangle('state.event_eff_ads_packages') }">
                    <h1>Currently Event Packages</h1>
                    <template x-for="package in JSON.parse(event_eff_ads_packages)">
                        <div x-data="{ open: false }" class="border rounded-md">
                            <button @click="open = !open" type="button"
                                class="w-full text-left p-3 bg-gray-50 hover:bg-gray-100 flex justify-between items-center">
                                <span class="font-medium text-gray-700" x-text="package.title"></span>
                            ...
                            <div x-show="open" x-collapse class="p-3 space-y-2">
                                ...
                                <button wire:click="removeEffAdsPackageFromEvent(package)" type="button"
                                    class="w-full px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none">
                                    Remove this package from event
                                </button>
                            </div>
