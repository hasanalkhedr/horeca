...
@section('content')
    <div class="row p-2 m-2">
        <div class="text-center">
            <h1 class="font-extrabold text-3xl text-gray-800">{{ $event->name }}</h1>
        </div>
    </div>
    <div class="row">
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Contracts</p>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Event Sales</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{ $event->Contracts->sum('net_total') }} US$
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                ...
                                <h5 class="font-weight-bolder mb-0">
                                    {{ $event->soldStands()->sum('space') }} SQM
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                ...
                                <h5 class="font-weight-bolder mb-0">
                                    {{ $event->availableStands()->sum('space') }} SQM
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-7">
                            ...
                            <p class="text-sm mb-0">
                                ...
                                <span class="font-weight-bold ms-1">{{ $event->Contracts->count() }} done</span>
                            </p>
                        </div>
                                ...
                                @foreach ($event->Contracts as $contract)
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm">{{ $contract->contract_no }}</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            ...
                                            <div class="progress-wrapper w-75 mx-auto">
                                                <div class="progress-info">
                                                    <div class="progress-percentage">
                                                        <span class="text-xs font-weight-bold">{{ $contract->net_total }}
                                                            US$</span>
                                                    </div>
                                                </div>
                                                <div class="progress">
                                        ...
                                        <td class="align-middle text-center">
                                            <a target="_blank"
                                                href="{{ route('contracts.preview', $contract) }}"><x-primary-button>Preview</x-primary-button></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                        ...
                        @foreach ($event->Reports as $report)
                            <div class="timeline-block mb-3">
                                ...
                                <div class="timeline-content">
                                    <h6 class="text-dark text-sm font-weight-bold mb-0">{{ $report->name }}</h6>
                                </div>
                                <a href="/contracts/create/{{ $event->id }}?report_id={{ $report->id }}">
                                    <x-primary-button>Add New Contract</x-primary-button>
                                </a>
                            </div>
                        @endforeach
                        <div class="timeline-block mb-3">
                ...
                <div class="card-body px-0 pb-2">
                    <div class="grid grid-cols-2 gap-2 w-full">
                        @foreach ($event->Categories as $category)
                            <div class="px-2">
                                <label class="hover:font-bold">{{ $category->name }}</label>
                            </div>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="card-header pb-0">
                    <div class="row">
                        <div class="col-lg-6 col-7">
                            ...
                            <p class="text-sm mb-0">
                                <i class="fa fa-check text-info" aria-hidden="true"></i>
                                <span class="font-weight-bold ms-1">{{ $event->soldStands->count() }} Sold, {{ $event->availableStands->count() }} Available</span>
                            </p>
                        </div>
                        <div class="col-lg-6 col-5 my-auto text-end">
                            <div class="dropdown float-lg-end pe-4">
                                ...
                                @foreach ($event->Stands as $stand)
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm">{{ $stand->no }}</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                ...
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm">{{ $stand->space }}</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <span class="text-xs font-weight-bold"> {{ $stand->status }} </span>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
