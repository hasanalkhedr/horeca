...
@section('content')
    <div class="container mx-auto px-4 py-8" x-data="packageShow()">
        <div class="flex justify-between items-center mb-6">
            <div>
                <a href="{{ route('ads-packages.index') }}" class="text-blue-500 hover:text-blue-700 flex items-center">
        ...
        <div x-show="activeTab === 'options'" class="bg-white rounded-lg shadow overflow-hidden mb-8">
            ...
            @if($adsPackage->adsOptions->count() > 0)
                <div class="divide-y divide-gray-200">
                    @foreach($adsPackage->adsOptions as $option)
                        <div class="px-6 py-4 flex justify-between items-center">
                            <div>
        ...
        function packageShow() {
            return {
                ...
                addCurrency() {
                    ...
                    fetch(`/ads-packages/${this.selectedPackageId}/add-currency`, {
                        method: 'POST',
                        headers: {
                ...
                removeCurrency(currencyId) {
                    ...
                    fetch(`/ads-packages/${this.selectedPackageId}/remove-currency/${currencyId}`, {
                        method: 'DELETE',
                        headers: {
                            'X-CSRF-TOKEN': '{{ csrf_token() }}',
                            'Accept': 'application/json'
                ...
                addOption() {
                    ...
                    fetch(`/ads-packages/${this.selectedPackageId}/attach-option`, {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': '{{ csrf_token() }}',
                        ...
                        body: JSON.stringify({
                            ads_option_id: this.newOption.id
                        })
                    })
                    .then(response => {
                        if (!response.ok) {
                ...
                removeOption(optionId) {
                    ...
                    fetch(`/ads-packages/${this.selectedPackageId}/detach-option/${optionId}`, {
                        method: 'DELETE',
                        headers: {
                            'X-CSRF-TOKEN': '{{ csrf_token() }}',
                            'Accept': 'application/json'
                ...
                submitForm() {
                    ...
                    fetch(`/ads-packages/${this.selectedPackageId}`, {
                        method: 'PUT',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': '{{ csrf_token() }}',
                ...
                confirmDelete() {
                    ...
                    .then(() => {
                        window.location.href = '{{ route("ads-packages.index") }}';
                    })
                    .catch(error => {
